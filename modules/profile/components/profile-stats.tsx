  ...
  const stats = [
    {
      ...
      bgColor: "bg-green-700", // was: bg-green-50 dark:bg-green-950/50
    },
    {
      icon: BarChart3,
      ...
      bgColor: "bg-blue-600", // was: bg-blue-50 dark:bg-blue-950/50
    },
    {
      icon: Award,
      ...
      bgColor: "bg-purple-700", // was: bg-purple-50 dark:bg-purple-950/50
    },
    {
      icon: Clock,
      ...
      bgColor: "bg-amber-900", // was: bg-amber-50 dark:bg-amber-950/50
    },
  ];
